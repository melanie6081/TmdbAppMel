...
@Composable
fun Series(windowClass: WindowSizeClass, navController: NavController){
        ...
        topBar = {
            if(searchActive){
                SearchBar(modifier = Modifier.padding(15.dp),
                    ...
                    onSearch = {viewmodel.getSerieSearched(textSearched)
                        searchActive = false
                        searchView = true},
                    active = true,
                    onActiveChange = {},
                    placeholder = {Text("Recherche Série")}
                ){}
            }else{
                TopAppBar(title = { Text("Recherche Série")},
                    navigationIcon ={
                        ...
                        Card( modifier = Modifier
                            ...
                            Column(horizontalAlignment = Alignment.CenterHorizontally){
                                ...
                                Row{
                                    Spacer(Modifier.width(8.dp))
                                    Text(
                                        text = stringToDate(it.first_air_date) ,
                                        overflow = TextOverflow.Ellipsis,
                                        maxLines = 1,
